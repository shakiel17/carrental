                  ...
                  <div class="x_content">
                    <br>
                     <table width="100%" border="0">
                        ...
                        <tr>
                            <td>
                                <b>PLATE NUMBER: <input type='text' name="plateno" style="width:200px;border:0;border-bottom:1px solid black;">
                            </td>
                            <td>
                                <b>FUEL: <input type='text' name="fuel" style="width:100px;border:0;border-bottom:1px solid black;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <b>TOTAL AMOUNT TENDERED </b><input type='text' name="tendered" style="width:100px;border:0;border-bottom:1px solid black;">
                            </td>
                        </tr>         
                        ...
                        <tr>
                            <td colspan="2">
                                <i>Agreed and recognized this <input type='text' name="signedday" style="width:50px;border:0;border-bottom:1px solid black; text-align:center;" value="<?=date('d');?>"> day of <input type='text' name="signedmonth" style="width:150px;border:0;border-bottom:1px solid black; text-align:center;" value="<?=date('F');?>">, <input type='text' name="singedyear" style="width:50px;border:0;border-bottom:1px solid black; text-align:center;" value="<?=date('Y');?>"></i>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
