    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-4">
                  ...
                  ?>
                  <a href="<?=base_url();?>car_booking/<?=$item['id'];?>" class="btn btn-primary py-2 ml-1">Book now</a>
                  <?php
                  }else{
                    echo "Unavailable";
                  }
                  ?>
                  <a href="<?=base_url();?>view_car_details/<?=$item['id'];?>" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>    			
                <?php
