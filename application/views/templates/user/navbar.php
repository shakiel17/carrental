	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              ?>
              <li class="nav-item"><a href="<?=base_url();?>user_bookings" class="nav-link">My Bookings</a></li>
	          <li class="nav-item"><a href="<?=base_url();?>user_profile" class="nav-link">Profile</a></li>
